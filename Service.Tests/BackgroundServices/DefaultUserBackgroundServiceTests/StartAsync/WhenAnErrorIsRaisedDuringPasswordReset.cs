...
{
    [TestFixture]
    public class WhenAnErrorIsRaisedDuringPasswordReset : DefaultUserBackgroundServiceTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            UserService.Setup(s => s.UpdatePasswordAsync(It.IsAny<User>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))
        ...
        [Test]
        public void The_Default_Password_Set_Is_Attempted()
        {
